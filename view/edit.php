<main role="main" class="col-md-9 ml-sm-auto col-lg-10 pt-3 px-4">
	<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center pb-2 mb-3 border-bottom">
        <h1 class="h2"><i class="fa-solid fa-gears fa-xl"></i>&nbsp;Zoning and Land Use Application Record</h1>
  	</div> 
  	<form method="POST" action="<? echo URL ?>ZoningAdmin/save_lup_updates/<? echo $permit_num;?>">
	<section class="ftco-section">
		<div class="container-fluid">
			<div class="row">
				<div class="col-md-2">
					<a id='back_lup_button' href='<?php echo URL;?>zoningadmin/pages/permits' class='button_style' title='BACK TO PERMITS'>BACK</i></a>
				</div>
				<div class="col-md-2 PAD1">
					<a id='back_button' type='button' class='button_style' title='PREVIOUS PENDING APPLICATION' href="<?php echo URL;?>zoningadmin/back_edit/<? echo $permit_num;?>"><i class="fa-solid fa-circle-left"></i></a>
					<a id='next_button' type='button' class='button_style' title='NEXT PENDING APPLICATION'  href="<?php echo URL;?>zoningadmin/next_edit/<? echo $permit_num;?>"><i class="fa-solid fa-circle-right"></i></a>
				</div>
				<div class="col-md-7">
    		...
    		<div class='color_back'>
    			...
    			<div class="row">
    				<div class="col-md-2">
    					<label>LOT NO</label>
    						<input id='property_lot_no' name='property_lot_no' class='land_use_input ADMIN_EDIT' value='<?php if(isset($property_lot_no)) echo $property_lot_no?>' min=0 type='number'/>
    				</div>
    				<div class="col-md-2">
    					<label>BLOCK</label>
    						<input id='property_block_no' name='property_block_no' class='land_use_input ADMIN_EDIT' value='<?php if(isset($property_block_no)) echo $property_block_no?>' min=0 type='number'/>
    				</div>
    				<div class="col-md-2">
    			...
    			<div class="row">
    				<div class="col-md-2">
    					<label>LOT NO</label>
    						<input id='property_lot_no2' name='property_lot_no2' class='land_use_input ADMIN_EDIT' value='<?php if(isset($property_lot_no2)) echo $property_lot_no2?>' min=0 type='number'/>
    				</div>
    				<div class="col-md-2">
    					<label>CSM NO</label>
    						<input id='property_csm_no' name='property_csm_no' class='land_use_input ADMIN_EDIT' value='<?php if(isset($property_csm_no)) echo $property_csm_no?>' min=0 type='number'/>
    				</div>
    				<div class="col-md-2">
    					<label>VOL</label>
    						<input id='property_vol_no' name='property_vol_no' class='land_use_input ADMIN_EDIT' value='<?php if(isset($property_vol_no)) echo $property_vol_no?>' min=0 type='number'/>
    				</div>
    				<div class="col-md-2">
    					<label>PG</label>
    		...
    		<div class='color_back'>
    			...
    			<div id='RESIDENTIAL' <?php if(isset($structure_res) && $structure_res == 0){ echo 'hidden';}?>>
        			...
        			<div class="row">
        				...
        				<div class="col-md-2 offset-md-2">
        					<label>GARAGE SQ. FT.</label>
        					<input id='structure_res_gar_sqft' name='structure_res_gar_sqft' class='land_use_input' value='<?php if(isset($structure_res_gar_sqft)) echo $structure_res_gar_sqft?>' type='number' type='number' readonly/>
        				</div>
        			</div>
        			<div class="row">
        				<div class="col-md-3">
    			...
    			<div class="row">
    				...
    				<div class="col-md-2">
    					...
    					<input id='additional_no_bed' name='additional_no_bed' class='land_use_input ADMIN_EDIT' value='<?php if(isset($additional_no_bed)) echo $additional_no_bed?>' min=0 type='number'/>
    				</div>
    				<div class="col-md-2">
    				...
    				<div class="col-md-12">
        				<div id='permit_fees'>
    						<div id='calculator' class='calculator'>
    							...
    							<select id='fee_section' title='USE TYPE'>
    							...
    							<select id='fee_subsection' title='USE SUBTYPE'></select>
    							<input id='fee_subsection_count' value=0 hidden>&nbsp;
    							<i onclick="window.open(src='<?php echo URL; ?>img/FEES_2024.pdf', '_blank');" title='CLICK' class="fa-solid fa-circle-info fa-lg" style='cursor: pointer;'></i>
    							<br/>
    							<i class="fa-solid fa-equals fa-lg text-dark"></i>&nbsp;&nbsp;&nbsp;&nbsp;<i class="fa-solid fa-dollar-sign fa-lg"></i>
    							<input id='fee_answer' readonly>
    						</div>
    					</div>
    				</div>
    			</div>
